...
import com.kotlinbootcamp.databinding.GdgListItemBinding
...
class GdgListAdapter(val clickListener: GdgClickListener): ListAdapter<GdgChapter, GdgListAdapter.GdgListViewHolder>(DiffCallback){
    ...
    class GdgListViewHolder(private var binding: GdgListItemBinding):
        ...
        companion object {
            fun from(parent: ViewGroup): GdgListViewHolder {
                ...
                val binding = GdgListItemBinding.inflate(layoutInflater, parent, false)
